...
public class AddToCartCommand implements Command {
  ...
  private static final String WRONG_ID_MESSAGE
      = "Цієї книги немає в каталозі, будь-ласка перевірте перевірте введений номер та спробуйте ще раз!";
  private static final String ENTER_QUANTITY_MESSAGE = "Введіть потрібну кількість кижок";
  private static final String WRONG_QUANTITY_MESSAGE =
      "Дуже дивна кількість, введість число більше за 0!";
  ...
  public AddToCartCommand(CatalogService catalogService, CartPartService cartPartService,
  ...
  public String doCommand() {
    ...
    return BOOK_MESSAGE + book.getBookTitle() + IN_QUANTITY_MESSAGE + quantity
