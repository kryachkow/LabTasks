...
class OrderServiceImplTest {
  ...
  void setUp() throws NoSuchFieldException, IllegalAccessException {
    ...
    Order order = new Order(LocalDateTime.of(1999, 11, 22, 22, 22, 22, 22),
        List.of(new CartPart()));
    Order order2 = new Order(LocalDateTime.of(2002, 1, 22, 22, 22, 22, 22),
        List.of(new CartPart()));
    Order order3 = new Order(LocalDateTime.of(2005, 1, 22, 22, 22, 22, 22),
        List.of(new CartPart()));
  ...
  void getClosestEntry() {
    ...
    Assertions.assertEquals(order,
        orderService.getClosestEntry(LocalDateTime.of(1997, 1, 22, 22, 22, 22, 22)));
    Assertions.assertEquals(order2,
        orderService.getClosestEntry(LocalDateTime.of(2001, 1, 22, 22, 22, 22, 22)));
  }
  ...
  void addOrder() {
    ...
    Order order2 = new Order(LocalDateTime.of(1994, 11, 22, 22, 22, 22, 22),
        List.of(new CartPart(), new CartPart()));
